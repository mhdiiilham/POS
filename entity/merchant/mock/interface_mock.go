...
// Source: entity/merchant/interface.go
...
import (
	...
	merchant "github.com/mhdiiilham/POS/entity/merchant"
)
...
func (m *MockRepository) Create(ctx context.Context, entity merchant.Merchant) (int, error) {
	m.ctrl.T.Helper()
